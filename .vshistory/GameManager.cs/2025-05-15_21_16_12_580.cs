   ...
   */
    public class GameManager
    {
      ...
      */
        ...
        * 5. Provide feedback to the user if an action cannot be performed (e.g., starting a new round before a game).
        *************************************************
        * @Param
        * Receives no parameters.
        *************************************************
        ...
        *************************************************
        * @Examples
        * // This method is typically called internally within the Start() method.
