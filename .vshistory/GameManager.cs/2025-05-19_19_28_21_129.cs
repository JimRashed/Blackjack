    ...
    */
       ...
       */
        ...
        private void PrintGameRules()
        {
            ...
            Console.WriteLine("When a round begins, 2 cards are dealt to each player and to the dealer. If a player's hand is worth 21 during the initial deal, that is called a 'Blackjack', the best possible hand. This guarantees that the player or the dealer with a blackjack will either win or tie.");
            Console.WriteLine("Now that you know the goal of the game, how do individual rounds go down? Press enter to go to the next page.");
