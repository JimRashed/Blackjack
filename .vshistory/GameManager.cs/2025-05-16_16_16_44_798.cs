   ...
   */
    ...
    */
       ...
       * @Algorithm:
           ...
           * 11 Wait for user input before conti * 4. Determine the outcome of their hand compared to the dealer's hand using game rules.
           ...
           * 9. Record the outcome on the lenuing.
       ...
       *************************************************
       * @Examples
       * // This method is called after the dealer has completed their turn.
       * // gameManager.Outcome();
       *************************************************
       * @Pseudocode
       * For each player in game.players
