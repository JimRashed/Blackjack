...
namespace Rashed_Blackjack
{
    public class Leaderboard
    {
       ...
       *************************************************
       * @Algorithm:
       * 1. Set entryExists to false.
       * 2. If the leaderboard (entries) is not empty:
       * For each entry in entries:
       * If entry's Name is equal to name:
       * Set entryExists to true.
       * Call entry.Modify(outcome).
       * 3. If entryExists is false:
       * Create a new LeaderboardEntry with name.
       * Call newEntry.Modify(outcome).
       * Add newEntry to entries.
       * 4. If the number of entries is greater than 1:
       * Call Sort().
       *************************************************
       * @Param
       * name: The name of the player.
       * outcome: The outcome of the round.
       *************************************************
       * @Exceptions
       * None
       *************************************************
